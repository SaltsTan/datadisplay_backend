...
import org.jeecg.common.util.BusinessHelpUtil;
...
//	}
	...
	public void download(@RequestBody JSONObject object, HttpServletResponse response) throws Exception {
		...
		try {
			...
			String fileName = filePath.substring(filePath.lastIndexOf("/"));
	 			...
	 			inputStream = BusinessHelpUtil.picUrlToInputStream(filePath);
                 if(inputStream != null){
                     outputStream = response.getOutputStream();
                     byte[] buf = new byte[1024];
                     int len;
