...
public class SysPositionController {
     ...
     * @return
     */
    @AutoLog(value = "职务添加",operateType = CommonConstant.OPERATE_TYPE_2)
     ...
     * @return
     */
    @AutoLog(value = "职务编辑",operateType = CommonConstant.OPERATE_TYPE_3)
     ...
     * @return
     */
    @AutoLog(value = "职务删除",operateType = CommonConstant.OPERATE_TYPE_4)
     ...
     * @return
     */
    @AutoLog(value = "职务批量删除",operateType = CommonConstant.OPERATE_TYPE_4)
