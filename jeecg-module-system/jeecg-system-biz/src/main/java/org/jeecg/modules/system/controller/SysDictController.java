...
public class SysDictController {
	...
	@AutoLog(value = "字典添加",operateType = CommonConstant.OPERATE_TYPE_2)
	...
	@AutoLog(value = "字典编辑",operateType = CommonConstant.OPERATE_TYPE_3)
	...
	@AutoLog(value = "字典删除",operateType = CommonConstant.OPERATE_TYPE_4)
	...
	@CacheEvict(value= {CacheConstant.SYS_DICT_CACHE, CacheConstant.SYS_ENABLE_DICT_CACHE}, allEntries=true)
	@AutoLog(value = "字典批量删除",operateType = CommonConstant.OPERATE_TYPE_4)
