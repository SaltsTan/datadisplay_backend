...
public class SysCategoryController {
	...
	@AutoLog(value = "字典分类添加",operateType = CommonConstant.OPERATE_TYPE_2)
	...
	@AutoLog(value = "字典分类编辑",operateType = CommonConstant.OPERATE_TYPE_3)
	...
	@AutoLog(value = "字典分类删除",operateType = CommonConstant.OPERATE_TYPE_4)
	...
	@AutoLog(value = "字典分类批量删除",operateType = CommonConstant.OPERATE_TYPE_4)
