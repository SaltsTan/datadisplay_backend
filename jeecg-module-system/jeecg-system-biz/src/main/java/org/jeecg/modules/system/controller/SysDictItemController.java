...
public class SysDictItemController {
	...
	@AutoLog(value = "字典项添加",operateType = CommonConstant.OPERATE_TYPE_2)
	...
	@CacheEvict(value={CacheConstant.SYS_DICT_CACHE, CacheConstant.SYS_ENABLE_DICT_CACHE}, allEntries=true)
	@AutoLog(value = "字典项编辑",operateType = CommonConstant.OPERATE_TYPE_3)
	...
	@CacheEvict(value={CacheConstant.SYS_DICT_CACHE, CacheConstant.SYS_ENABLE_DICT_CACHE}, allEntries=true)
	@AutoLog(value = "字典项删除",operateType = CommonConstant.OPERATE_TYPE_4)
	...
	@CacheEvict(value={CacheConstant.SYS_DICT_CACHE, CacheConstant.SYS_ENABLE_DICT_CACHE}, allEntries=true)
	@AutoLog(value = "字典项批量删除",operateType = CommonConstant.OPERATE_TYPE_4)
