...
public class JeecgController<T, S extends IService<T>> {
    ...
    protected Result<?> importExcel(HttpServletRequest request, HttpServletResponse response, Class<T> clazz) {
        ...
        for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
            ...
            try {
                ...
                List<T> collect = list.stream().filter(i -> !nullObjFilter(i, clazz)).collect(Collectors.toList());
    ...
    public static <T> boolean nullObjFilter(T obj, Class<T> clazz) {
        ...
        //移除序列id
        boolean flag = Arrays.stream(declaredFields).anyMatch(i -> i.getName().equals("serialVersionUID"));
