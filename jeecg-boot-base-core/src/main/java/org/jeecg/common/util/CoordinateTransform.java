...
public class CoordinateTransform {
    ...
    public static double[] transformBD09ToWGS84(double lng, double lat) {
        double[] gcj02 = transformBD09ToGCJ02(lng, lat);
        return transformGCJ02ToWGS84(gcj02[0], gcj02[1]);
    }
    ...
    public static double[] transformWGS84ToBD09(double lng, double lat) {
        double[] gcj02 = transformWGS84ToGCJ02(lng, lat);
        return transformGCJ02ToBD09(gcj02[0], gcj02[1]);
    }
    ...
    private static double transformLat(double lng, double lat) {
        return -100.0 + 2.0 * lng + 3.0 * lat + 0.2 * lat * lat + 0.1 * lng * lat + 0.2 * Math.sqrt(Math.abs(lng)) +
    ...
    private static double transformLng(double lng, double lat) {
        return 300.0 + lng + 2.0 * lat + 0.1 * lng * lng + 0.1 * lng * lat + 0.1 * Math.sqrt(Math.abs(lng)) +
                (20.0 * Math.sin(6.0 * lng * PI) + 20.0 * Math.sin(2.0 * lng * PI)) * 2.0 / 3.0 +
